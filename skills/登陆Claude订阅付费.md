...
这是登陆 / 订阅 / 付费。找 Claude 问问题走 `skills/找Claude问问题.md`，不要混进这条。
...
个人 Pro / Max 结账没演示过，不要编那条路径。价格以开通页当场显示为准，不要用旧数字硬套。2026-08-19 演示基线：月付 2×Standard，$25/座/月，合计 $50 + tax，页 `https://claude.ai/create/team/billing`。
