...
9. 演示后续出现过 **What’s your name?** / So Claude knows what to call you，姓名预填 `{full_name}`，点 **Continue**。若先出现 **Before your first chat**（含训练数据开关），点 **Continue**；没演示过改开关，不要动。
10. 成功核验：`claude.ai/chat/...`，欢迎语带名字，左下角账号名和 **Free**。
