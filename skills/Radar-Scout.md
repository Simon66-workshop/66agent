...
Query 只读 `X-Radar-5核心.md`，不要改字。建立方式：https://x.com/i/radar 。V0.1 不用 X Search API。
...
4. 找到原始 Thread
5. 必要时补搜第一方来源
6. 输出：Radar、作者、URL、一句话信号、为何进池

## 禁止
不评分、不写内容卡、不因点赞高收录、不收录 crypto/招聘、不编造播放量。汽车内容不走这里。小红书选题走 `XHS-Topic-Pipeline.md`，不要把本 skill 改去扫小红书。
