...
- This skill is for TypeSafe System One / Jev typed judgments (routing, ranking, extraction, verification). It is **not** a browser-automation accelerator.
- Reference: https://github.com/typesafe-ai/skills and https://docs.typesafe.ai/llms.txt
- Companion repo https://github.com/vlad-terin/jev-use may 404; prefer live TypeSafe docs.
