...
辉哥说「问问 Claude」「让 Claude 看一下」「交叉验证」时用。把**用户原话事实**和**自己已汇总的官方/社区材料**一起丢给 Claude，要机制、最可能原因、每条置信度。不要让它空猜，也不要替它编答案。

这不是开通 Team、也不是充值。开通/加座走 `skills/开通ClaudeTeam并充值.md`。
