...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| 2026-08-28 | P1-RED | https://embracethered.com/blog/posts/2026/breaking-claude-code-opus-5-and-automode/ | Johann Rehberger / Radar @The_Cyber_News | Opus 5 Auto Mode：一句「总结这个网页」可走到代码执行；官方 Trajectory Labs 0.00%（720 次）与实验室 60–80%（n=5）同时成立 | 82 | P1 | Security | Auto Mode 当便利不当边界；未信任 URL 不要让它总结；沙箱+出口限制；分类器可能放行拉起进程再拦住清理 | | | | | 未核验 | | | | | 官文关单 Informative / working as designed；n=5 不是通用 ASR；接 8/25 共享电脑 |
